...
*   **Multi-language Support:** The interface is available in both **Portuguese** and **English**, with persistent language selection.
*   **Personal Quiz Library:** Save your uploaded quizzes directly in your browser's local storage. You can rename, delete, and revisit them anytime.
*   **Record Tracking:** The app automatically tracks and displays your highest score achieved for every saved quiz.
*   **Smart Upload Flow:** When uploading a new CSV, choose between starting the quiz immediately, saving it to your library, or both.
